 ...
 * v1.0.0(2016.9.23):
 初始生成
 * ---------------------------------------------------------------------------*/
 KISSY.add('page/store/all-order', function (S, Scroll, Core) {
    PW.namespace('page.Store.AllOrder');
    PW.page.Store.AllOrder = function (param) {
        new Scroll();
        new Core();
    }
}, {
...
/*滚动条相关操作*/
KISSY.add('all-order/scroll', function (S) {
    var
        DOM = S.DOM,
...
/*基本操作*/
KISSY.add('all-order/core', function (S) {
    var
        $ = S.all,
        DOM = S.DOM,
        on = S.Event.on,
